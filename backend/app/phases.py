SDLC_PHASES = [
    {
        ...
        "description": "Analyze the requirement document, extract functional and non-functional requirements, identify stakeholders, and define scope.",
...
- Make the document professional, specific, and implementation-ready without scope creep.""",
    },
    {
        "id": "system-design",
        "name": "System Design",
        "description": "Create high-level system design including system architecture, data flow diagrams, and component interactions.",
...
Be concrete, implementation-oriented, and tied to the exact product requirements. Avoid generic architecture filler.""",
    },
    {
        ...
        "description": "Define the technology stack, frameworks, tools, and infrastructure needed for the project.",
...
Use precise choices that fit the requested product. Explain why each choice is appropriate.""",
    },
    {
        ...
        "description": "Break down the project into sprints, tasks, and milestones with time estimates.",
...
Make the plan realistic, actionable, and detailed.""",
    },
    {
        ...
        "description": "Generate the actual application code based on all previous phases.",
...
Do NOT output multiple files. Do NOT add any explanation text before or after the code. Do NOT use markdown outside the file block. The ENTIRE application must be in this single index.html file.""",
    },
    {
        ...
        "description": "Define testing strategy, create test cases, and generate test code.",
...
Use realistic tests for the requested product and make them easy to run.""",
    },
    {
        ...
        "description": "Create deployment strategy, infrastructure setup, and go-live checklist.",
